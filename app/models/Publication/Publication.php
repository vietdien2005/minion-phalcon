...
class Publication extends Model
{
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('type_id', 'Models\Publication\Type', 'id', [
            'alias' => 'type'
        ]);
    }
    ...
    protected $translateModel = 'Models\Publication\Translate\PublicationTranslate'; // translate
    ...
    {
        $key = HOST_HASH . md5('Models\Publication\Publication; slug = ' . $slug);
        return $key;
    }
