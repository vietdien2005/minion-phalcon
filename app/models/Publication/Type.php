...
class Type extends Model
{
    ...
    protected $translateModel = 'Models\Publication\Translate\TypeTranslate';
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'Models\Publication\Publication', 'type_id', [
            'alias' => 'publications'
        ]);
    }
    ...
    public function validation()
    {
        ...
        $validator->add('slug', new UniquenessValidator(
            [
                "model"   => $this,
                "message" => "Type of publications with section URL = '" . $this->slug . "' already exists"
            ]
        ));
    ...
    {
        return HOST_HASH . md5('Models\Publication\Type; slug = ' . $slug);
    }

    public static function cacheListKey($params)
    {
        return HOST_HASH . md5('Models\Publication\Type; list; ' . serialize($params));
    }
