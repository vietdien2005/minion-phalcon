...
class Scanner
{
    ...
    public function search()
    {
        ...
        $files_plugins = $this->rsearch(APPLICATION_PATH . '/app/plugins', $files_pattern);
        $files_modules = $this->rsearch(APPLICATION_PATH . '/app/modules', $files_pattern);
        $files_views = $this->rsearch(APPLICATION_PATH . '/resources/volt', $files_pattern);
